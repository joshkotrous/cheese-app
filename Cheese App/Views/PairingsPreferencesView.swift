...
struct SelectableCategory3: Identifiable {
...
class PairingsPreferencesViewModel: ObservableObject {
    ...
    func getAllCategories() async {
        ...
        DispatchQueue.main.async {
            ...
            self.categories = fetchedCategories.map { category in
                SelectableCategory3(category: category, isSelected: false)
            }
    ...
    func toggleCategorySelection(_ category: SelectableCategory3) {
...
struct PairingsPreferencesView: View {
    @State private var opacity: Double = 0.0
    @StateObject var viewModel = PairingsPreferencesViewModel()
    ...
    var body: some View {
        ...
        ZStack{
            ...
            VStack(alignment: .leading){
                    Text("Choose your preferred cheese pairings")
